...
DATA_EX_DIR = path.join(DATA_DIR, 'train_data')                          # Path to the training examples directory
INFER_DIR = path.join(DATA_DIR, 'test_data')                              # Path to the inference examples directory
